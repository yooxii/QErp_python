...
from PySide2.QtWidgets import QApplication, QFileDialog  # 导入 QApplication
...
class DealTxt:
    ...
    def deal_data1(self, datas: List[str], qerp):
        res = []
        seqs = {}
    ...
    def deal_data2(self, datas: List, qerp):
